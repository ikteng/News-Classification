...
device = torch.device("cuda" if torch.cuda.is_available() else "cpu") # device handling
...
torch.save(model.state_dict(), r'news_classification\news_classification_model.pth')

# Load the saved model
model = TextClassificationModel(vocab_size, emsize, num_class).to(device)
model.load_state_dict(torch.load(r'news_classification\news_classification_model.pth'))
